        ...
        const fetchChart = async () => {
            ...
            try {
                const response = await fetch(
                    `https://data-analysis-api-8l1t.onrender.com/analysis/seasonality?sheet_name=${encodeURIComponent(selectedSheet)}`
                );
                if (!response.ok) {
                ...
                setImageUrl(`https://data-analysis-api-8l1t.onrender.com/plots/${data.plot_path.split('/').pop()}`);
            } catch (err: any) {
